...
$sq_airline1 = mysql_fetch_assoc(mysql_query("select * from airline_master where airline_id='$sq_plane[airline_name]'"));
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="print_info_list">
            <li class="col-md-6 mg_tp_10 mg_bt_10"><span>PREFERRED AIRLINE :</span><?= $sq_airline1['airline_name']; ?> </li>
          ...
          <hr class="main_block">
            <ul class="main_block">
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>SECTOR FROM : </span><?= $sq_plane['from_location'] ?></li>
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>SECTOR TO : </span><?= $sq_plane['to_location'] ?></li>
            </ul>
            <ul class="main_block">
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>CLASS TYPE : </span><?= $sq_plane['class'] ?></li>
            </ul>
          </div>
        </div>
      </div>
