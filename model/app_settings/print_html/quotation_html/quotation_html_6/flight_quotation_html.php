        ...
        <div class="packageDeatailPanel">
          ...
          <div class="landingPageBlocks">          
            ...
            <div class="detailBlock">
              ...
              <div class="detailBlockContent">
                <p>TOTAL SEATS : <?= $sq_plane['total_adult'] + $sq_plane['total_child'] ?></p>
              </div>
            </div>
            <div class="detailBlock">
              <div class="detailBlockIcon">
      ...
      <section class="endPageSection main_block mg_tp_30 pageSectionInner">
        ...
        <div class="row">
          ...
          <!-- <div class="col-md-4 passengerPanel endPagecenter mg_bt_30">
            <h3 class="endingPageTitle text-center">Total Passenger</h3>
            <div class="icon">
              <img src="images/quotation/p4/adult.png" class="img-responsive">
              <h4 class="no-marg">Adult : <php  //echo $sq_quotation['total_adult'] ?></h4>
              <i class="fa fa-plus"></i>
            </div>
            <div class="icon">
              <img src="images/quotation/p4/child.png" class="img-responsive">
              <h4 class="no-marg">Children : <php $sq_quotation['total_children'] ?></h4>
              <i class="fa fa-plus"></i>
            </div>
            <div class="icon">
              <img src="images/quotation/p4/infant.png" class="img-responsive">
              <h4 class="no-marg">Infant : <php $sq_quotation['total_infant'] ?></h4>
            </div>
          </div>
           -->
        <div class="col-md-8">
