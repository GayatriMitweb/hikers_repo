    ...
    <section class="print_sec main_block">
		...
		<tbody>
			...
			<tr>
				...
				<td>Other charges</td>
				<td class="text-right" style="border-right: 1px solid #ddd !important"><?= number_format($sq_salary['salary_advance']+$sq_salary['loan_ded']+$sq_salary['surcharge_deduction']+$sq_salary['cess_deduction']+$sq_salary['leave_deduction'],2)?></td>
				</tr>
			<tr>
				<td>Incentive</td>
