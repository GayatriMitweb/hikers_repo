...
<div class="row mg_tp_20">
					...
					while($row_ledger = mysql_fetch_assoc($sq_ledger_info)){
						...
						?>
							<tr>
								...
								<td><?= $debit_amount ?></td>
								<td style="border-right:1px grey solid !important;"><?= $credit_amount ?></td>
						...
						foreach($finalArray as $key=>$value){
							...
							if(sizeof($transactions) != 0){
								...
								<tr>
									...
									<td style="border-right:1px grey solid !important;"><?= number_format($acredit_amount,2) ?></td>
									<td><?= number_format($balance_column,2) ?></td>
								</tr>
								<?php
								if($side_t == '(Dr)'){
	...
	<table class="table no-marg" id="tbl_list_ledger_sub1" style="padding: 0px !important;">
		<tfoot>
		<?php if($chk_trans == 1){ ?>
			<tr class="table-heading-row">
				<td></td>
				...
				<td></td>
				<td class="text-right"><?= number_format($tdebit_amount,2) ?></td>
				<td class="text-right"><?= number_format($tcredit_amount,2) ?></td>
			</tr>
			<tr class="table-heading-row">
				<td></td>
				<td></td>
				...
				<td></td>
				<td class="text-right"><?= number_format($balance1,2).$side_t1 ?> </td>
				<td></td>
			</tr>
		<?php } else { ?>
			<tr class="table-heading-row">
				...
				<td></td>
				<td class="text-right">Total : </td>
				<td colspan="2" class="text-right"><?= number_format($total_debit1,2) ?></td>
				<td></td>
