...
<section class="print_header main_block mg_bt_20">
  ...
  <span class="title"><i class="fa fa-file-text"></i> Ratio Analysis <?php echo ($from_date!='') ? '('.get_date_user($from_date).')' : 
  ''; ?></span>
      ...
      { 
        ...
        $total_operating_amount = 0;
         ...
         { 	
			...
			if($from_date!=""){
				$from_date = get_date_db($from_date);
				$sq_finance .=" and payment_date <= '$from_date'";	
			}
			if($financial_year_id!=""){
