...
$branch_admin_id = $_POST['branch_admin_id'];
  ...
  for($i=0; $i<sizeof($activity_date_arr); $i++)
  {
    ...
    $sq = mysql_query("insert into daily_activity (id,emp_id, branch_admin_id,activity_date, activity_type,time_taken, description ) values ('$max_id','$emp_id', '$branch_admin_id','$activity_date_arr1', '$activity_type_arr[$i]', '$time_taken_arr[$i]', '$description1') ");
    if(!$sq)
    {
