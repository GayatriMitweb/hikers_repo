...
$whatsapp_msg .= rawurlencode('
*Total Cost* : '.$currency_logo.' '.number_format($costDetails[total_amount],2).'
*Taxes Applied* : '.$currency_logo.' '.number_format($costDetails[markup_tax] + $costDetails[tax_amount],2).'
*Net Total* : '.$currency_logo.' '.number_format($costDetails[total_amount],2)
.'
