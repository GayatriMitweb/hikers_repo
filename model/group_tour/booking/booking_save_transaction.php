   ...
   //////////Payment Amount///////////
	if($payment_mode != 'Credit Note'){
		...
		if($payment_mode == 'Credit Card'){
			...
			$payment_particular = get_sales_paid_particular(get_group_booking_id($booking_id,$yr1), $payment_date1, $credit_charges, $customer_id, $payment_mode, get_group_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
      ...
      $finance_charges = number_format($finance_charges,2);
			...
			$payment_date = $payment_date;
			$payment_particular = get_sales_paid_particular(get_group_booking_id($booking_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_group_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = 231;
			$payment_side = "Debit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
			...
			$payment_date = $payment_date;
			$payment_particular = get_sales_paid_particular(get_group_booking_id($booking_id,$yr1), $payment_date1, $credit_company_amount, $customer_id, $payment_mode, get_group_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = $company_gl;
			$payment_side = "Debit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
			...
			$payment_date = $payment_date;
			$payment_particular = get_sales_paid_particular(get_group_booking_id($booking_id,$yr1), $payment_date1, $payment_amount1, $customer_id, $payment_mode, get_group_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = $pay_gl;
			$payment_side = "Debit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
