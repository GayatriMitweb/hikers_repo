...
$sq_settings = mysql_fetch_assoc(mysql_query("select * from app_settings where setting_id='1'"));
...
function email($tax_pay_date,$tax_type)
{
	...
	$model->app_email_send('90',"Admin",'sonam.itweb@gmail.com', $content, $subject);
}
