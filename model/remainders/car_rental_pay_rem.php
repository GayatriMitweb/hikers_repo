...
$sq_car_rental= mysql_num_rows(mysql_query("select * from car_rental_booking where due_date='$due_date' and status!='Cancel'"));

if($sq_car_rental>0){

	$sq_car_rental_details = mysql_query("select * from car_rental_booking where due_date='$due_date' and status!='Cancel'");
