          ...
          <table class="table table-bordered no-marg" id="tbl_emp_list">
            ...
            <?php 
             $sq_cruise = mysql_query("select * from group_tour_quotation_cruise_entries where quotation_id='$quotation_id'");
              while($row_train = mysql_fetch_assoc($sq_cruise))
              {
                ?>
                <tr>
          ...
          <!-- Nav tabs -->
            ...
            <div class="tab-content responsive">
              ...
              <div role="tabpanel" class="tab-pane active" id="terms">
                <pre><?php
                  $sq_query = mysql_fetch_assoc(mysql_query("select * from terms_and_conditions where type='Group Quotation' and active_flag='Active'")); 
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-12">
              ...
              <div class="feedback_btn succes mg_bt_20">
                ...
                <button value="Interested in Booking"><a href="quotation_email_interested.php?quotation_id=<?php echo $quotation_id; ?>" style="color:#ffffff;text-decoration:none">I'm Interested</a>
            ...
            <div class="col-sm-4 col-xs-12">
              ...
              <div class="feedback_btn danger mg_bt_20">
               ...
               <button value="Interested in Booking"><a href = "quotation_email_not_interested.php?quotation_id=<?php echo $quotation_id; ?>" style="color:#ffffff;text-decoration:none">Not Interested</a>
