	...
	<div class="container">	
        <div class="row">
            ...
            <div class="col-md-12 col-sm-8 col-xs-12 no-pad table-responsive"> 
                ...
                ?>
                    <tr>
                        <td style="width: 50px;"><input class="css-checkbox mg_bt_10" id="chk_program-u_<?= $count ?>" type="checkbox" checked><label class="css-label" for="chk_program-u_<?= $count ?>"> <label>
            </td>
                        ...
                        <td><select name="meal_plan-u_<?= $count ?>" id="meal_plan-u_<?= $count ?>" style="width:145px;" title="Room Category" class="form-control app_select2"><?php get_mealplan_dropdown(); ?>
		    ...
		    <div class="row text-center mg_tp_20" style="margin-right:0px">
			    <div class="col-xs-12">
