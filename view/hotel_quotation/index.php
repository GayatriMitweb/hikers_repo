...
$sq = mysql_fetch_assoc(mysql_query("select * from branch_assign where link='hotel_quotation/index.php'"));
   ...
   <div class="app_panel_content Filter-panel">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12 mg_bt_10_xs">
                    <input type="text" id="from_date_filter" name="from_date_filter" placeholder="From Date" title="From Date" onchange="validate_validDate('from_date_filter','to_date_filter');get_to_date(this.id,'to_date_filter');">
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12 mg_bt_10_xs">
            ...
            <div class="row mg_tp_20">
                <div class="col-md-12 no-pad">
                    <div class="table-responsive">
                        <table id="hotel_quotation_table" class="table table-hover" style="margin: 20px 0 !important;">
                        </table>
                    </div>
                </div>
            </div>
...
function send_mail(){
    var base_url = $('#base_url').val();
    var branch_status = $('#branch_status').val();
	$.get(base_url+'view/hotel_quotation/send_quotation.php', {branch_status : branch_status}, function(data){
		$('#div_quotation_form').html(data);
	});
}
