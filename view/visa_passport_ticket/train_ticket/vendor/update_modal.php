...
$sq_vendor_login = mysql_fetch_assoc(mysql_query("select * from vendor_login where username='$sq_vendor[vendor_name]' and password='$sq_vendor[mobile_no]' and vendor_type='Train Ticket Vendor'"));
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update Train-Ticket Information</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="vendor_name1" name="vendor_name1" onchange="validate_spaces(this.id);"  placeholder="*Supplier Name" title="Supplier Name" value="<?= $sq_vendor['vendor_name'] ?>">
          </div>
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="mobile_no1" name="mobile_no1" placeholder="*Mobile No" title="Mobile No" onchange="mobile_validate(this.id);" value="<?= $mobile_no ?>" required>
         </div>
         <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" class="form-control" value="<?= $sq_vendor['landline_no'] ?>" id="landline_no1" name="landline_no1" onchange="mobile_validate(this.id);" placeholder="Landline Number" title="Landline Number">
          </div>
          <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <textarea id="address1" name="address1" onchange="validate_address(this.id);" placeholder="Address" title="Address" rows="1"><?= $sq_vendor['address'] ?></textarea>
          </div> 
        ...
        <div class="row"> 
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
             <input type="text" id="supp_pan1" name="supp_pan" onchange="validate_alphanumeric(this.id);" value="<?= $sq_vendor['pan_no']?>" placeholder="PAN/TAN No" title="PAN/TAN No" style="text-transform: uppercase;">
          </div>  
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="hidden" id="opening_balance1" name="opening_balance1" onchange="validate_balance(this.id);" placeholder="Opening Balance" title="Opening Balance" value="<?= $sq_vendor['opening_balance'] ?>" <?= $value ?>  >
          </div>     			
...
$('#frm_update').validate({
  ...
  submitHandler:function(form){
      ...
      $.ajax({
        type: 'post',
        url: base_url+'controller/visa_passport_ticket/train_ticket/vendor/vendor_update.php',
