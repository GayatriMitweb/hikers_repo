  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Passport Details</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="mobile_no" name="mobile_no" placeholder="*Mobile No" title="Mobile No" onchange="mobile_validate(this.id);" required>
          </div>   
          <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <textarea id="address" name="address" placeholder="Address" title="Address" rows="1" onchange="validate_address(this.id)"></textarea>
          </div>
          <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" name="account_no" id="account_no" placeholder="A/c No" title="A/c No" onchange="validate_accountNo(this.id);">
          </div> 
           <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" name="branch" onchange="validate_branch(this.id);" id="branch" placeholder="Branch" title="Branch">
          </div> 
        </div>
        <div class="row">
          <div class="col-md-3 col-sm-6 mg_bt_10">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" name="service_tax_no" id="service_tax_no" placeholder="Tax No" onchange="validate_alphanumeric(this.id)" title="Tax No" style="text-transform: uppercase;">
          </div>
         <div class="col-md-3 col-sm-6 mg_bt_10">
