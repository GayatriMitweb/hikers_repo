...
$sq_vendor = mysql_fetch_assoc(mysql_query("select * from passport_vendor where vendor_id='$vendor_id'"));
$sq_vendor_login = mysql_fetch_assoc(mysql_query("select * from vendor_login where username='$sq_vendor[vendor_name]' and password='$sq_vendor[mobile_no]' and vendor_type='Passport Vendor'"));
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update Passport Supplier Information</h4>
      </div>
      <div class="modal-body">
      <div class="panel panel-default panel-body app_panel_style feildset-panel">
        <legend>Passport Supplier Information</legend>
        <div class="row">
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="vendor_name1" name="vendor_name1" placeholder="Company Name" title="Company Name" onchange="validate_spaces(this.id);" value="<?= $sq_vendor['vendor_name'] ?>">
          </div>
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="mobile_no1" onchange="mobile_validate(this.id);" name="mobile_no1" placeholder="*Mobile No" title="Mobile No" value="<?= $mobile_no ?>" required>
          </div>  
          <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <textarea id="address1" name="address1" placeholder=" Address"  title="Address" onchange="validate_address(this.id)" rows="1"><?= $sq_vendor['address'] ?></textarea>
          </div>  
          <div class="col-md-3 col-sm-6 mg_bt_10">
      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
        <legend>Bank Information</legend>
          <div class="row">
              ...
              <div class="col-md-3 col-sm-6 mg_bt_10">
                <input type="text" name="account_no1" id="account_no1" placeholder="A/c No" title="A/c No" value="<?= $sq_vendor['account_no']?>" onchange="validate_accountNo(this.id);" >
              </div>
              <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row"> 
            <div class="col-md-3 col-sm-6 mg_bt_10">
              <input type="text" name="ifsc_code1" id="ifsc_code1" placeholder="IFSC/SWIFT CODE" onchange="validate_IFSC(this.id);" title="IFSC/SWIFT CODE" value="<?= $sq_vendor['ifsc_code']?>" style="text-transform: uppercase;"> 
            </div>
            <div class="col-md-3 col-sm-6 mg_bt_10">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
              <input type="text" id="supp_pan1" onchange="validate_alphanumeric(this.id);" name="supp_pan" value="<?= $sq_vendor['pan_no']?>" placeholder="PAN/TAN No" title="PAN/TAN No" style="text-transform: uppercase;">
            </div> 
            <div class="col-md-3 col-sm-6 mg_bt_10">
...
$('#frm_update').validate({
  ...
  submitHandler:function(form){
      ...
      $.ajax({
        type: 'post',
        url: base_url+'controller/visa_passport_ticket/passport/vendor/vendor_update.php',
