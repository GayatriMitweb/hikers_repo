            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <li class="dropdown">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown_menu no-pad">
                    <li><span onclick="show_report_reflect('Sales Forecast')">Sales Forecast</span></li>
...
function show_report_reflect(report_name){
    ...
    if(report_name=="Sales Forecast"){ url = 'report_reflect/sales_projection/projection/index.php?branch_status=<?= $branch_status ?>'; }
