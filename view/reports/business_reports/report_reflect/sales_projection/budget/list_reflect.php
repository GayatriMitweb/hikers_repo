    ...
    <table class="table table-hover" id="tbl_list" style="margin: 20px 0 !important;">
        ...
        <tbody>
            <?php  
                ...
                $sq_f1 = mysql_fetch_assoc(mysql_query("select sum(payment_amount) as sum from finance_transaction_master where gl_id='50' and date(created_at) between '$from_date1' and '$to_date1'"));
                $sq_f2 = mysql_fetch_assoc(mysql_query("select sum(payment_amount) as sum from finance_transaction_master where gl_id='174' and date(created_at) between '$from_date1' and '$to_date1'"));
...
function calculate_sale(){
 ...
 //Flight
    var bud_f = document.getElementById("bud_s_f").innerText;bud_f
    ...
    var act_f1 = parseFloat(sale_f1)/ parseFloat(bud_s_f1);
    document.getElementById('act_f1').innerHTML = act_f1.toFixed(2)+'%';

    var pro_f1 = (parseFloat(pro_c_f1) + parseFloat(pro_h_f1) + parseFloat(pro_s_f1))/avg_f1/100;
