...
//Flight
$enq_strong_c1 = mysql_num_rows(mysql_query("select enquiry_content from enquiry_master where enquiry_date between '$from_date1' and '$to_date1' and enquiry='Strong' and enquiry_type='Flight Ticket'"));
$enq_strong_f = mysql_query("select enquiry_content from enquiry_master where enquiry_date between '$from_date1' and '$to_date1' and enquiry='Strong' and enquiry_type='Flight Ticket'"); 
while($row_s= mysql_fetch_assoc($enq_strong_f)){
    $enquiry_content = $row_s['enquiry_content'];
    $enquiry_content_arr1 = json_decode($enquiry_content, true);

    $budget_s_f += $enquiry_content_arr1[0]['budget'];
}
...
while($row_h= mysql_fetch_assoc($enq_hot_f)){
    $enquiry_content = $row_h['enquiry_content'];
    $enquiry_content_arr1 = json_decode($enquiry_content, true);
    $budget_h_f += $enquiry_content_arr1[0]['budget'];
}
...
while($row_c= mysql_fetch_assoc($enq_cold_f)){
    $enquiry_content = $row_c['enquiry_content'];
    $enquiry_content_arr1 = json_decode($enquiry_content, true);
    $budget_c_f += $enquiry_content_arr1[0]['budget'];
}
