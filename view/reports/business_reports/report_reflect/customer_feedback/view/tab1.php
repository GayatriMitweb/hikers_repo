...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="profile_box main_block">
            ...
            <?php if($sq_feed['sales_team_comment'] != ''){ ?>
            <div class="row mg_tp_10 mg_bt_10">
              <div class="col-md-12 col-xs-12"><h5><?= $sq_feed['sales_team_comment'] ?></h5></div>
            </div>
            <?php } ?>
            <hr class="no-marg main_block">
            <div class="row mg_tp_10 mg_bt_10">
              <div class="col-xs-12">
                ...
                <div class="col-xs-12">
                  ...
                  <div class="col-md-4 col-xs-12">
                    <h5 class="no-marg" style="margin-left: 10px !important;"><?= $sq_feed['vehicles_requested'] ?></h5>
                  </div>
                </div>
                <div class="col-xs-12">
