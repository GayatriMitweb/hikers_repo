...
<div class="row mg_tp_20"> <div class="col-md-12 no-pad"> <div class="table-responsive">
    ...
    <table class="table table-hover" id="tbl_listgs" style="margin: 20px 0 !important;">
        <thead>
        ...
        <tbody>
            ...
            if($sq_group_count!="0" || $sq_group_pre_count!='0'){
                ...
                <!-- Group Booking -->
                <tr> 
                    <td><b>Group Sale</b></td>
                    <td></td><td></td><td></td><td></td>
                </tr>
                <?php
                $sql_grp = mysql_query("select * from tourwise_traveler_details");
                while($row=mysql_fetch_assoc($sql_grp)){

                    $customer_id = $row['customer_id'];
                    $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));

                    $sq_group = mysql_fetch_assoc(mysql_query("select sum(net_total) as net_total from tourwise_traveler_details where financial_year_id='$financial_year_id' and customer_id='$customer_id' and tour_group_status!='Cancel'"));
                    $sq_group_pre = mysql_fetch_assoc(mysql_query("select sum(net_total) as net_total from tourwise_traveler_details where financial_year_id='$pre_financial_year_id' and customer_id='$customer_id' and tour_group_status!='Cancel'"));
                    $current_group_sale = $sq_group['net_total'];
                    $previous_group_sale = $sq_group_pre['net_total'];

                    $sq_group_month = mysql_fetch_assoc(mysql_query("SELECT sum(net_total) as net_total
                    FROM  tourwise_traveler_details WHERE MONTH(form_date) = $month AND financial_year_id='$financial_year_id' and customer_id='$customer_id' and tour_group_status!='Cancel'"));
                    $sq_group_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(net_total) as net_total
                    FROM  tourwise_traveler_details WHERE MONTH(form_date) = $month AND financial_year_id='$pre_financial_year_id' and customer_id='$customer_id' and tour_group_status!='Cancel'"));
                    $current_group_sale_m = $sq_group_month['net_total'];
                    $previous_group_sale_m = $sq_group_month_pre['net_total'];

                    $is_exist =  in_array($ledger_name['ledger_name'],$grp_ledger_arr);
                    array_push($grp_ledger_arr,$ledger_name['ledger_name']);
                    if($is_exist!=1){
                        ?>
                        <tr> 
                            <td><?= $ledger_name['ledger_name'] ?></td>
            ...
            ?>
            <tr>
                <td><b>Package Sale</b></td>
                <td></td><td></td><td></td><td></td>
            </tr>
            <?php
           $pckg_ledger_arr = array();
            $sql_package = mysql_query("select * from package_tour_booking_master");
            while($row=mysql_fetch_assoc($sql_package)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
            $sq_package = mysql_fetch_assoc(mysql_query("select sum(net_total) as net_total from package_tour_booking_master where financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
            $sq_package_pre = mysql_fetch_assoc(mysql_query("select sum(net_total) as net_total from package_tour_booking_master where financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
    
            $current_package_sale = $sq_package['net_total'];
            $previous_package_sale = $sq_package_pre['net_total'];
    
            $sq_package_month = mysql_fetch_assoc(mysql_query("SELECT sum(net_total) as net_total
            FROM package_tour_booking_master WHERE MONTH(booking_date) = $month AND financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
            $sq_package_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(net_total) as net_total
            FROM package_tour_booking_master WHERE MONTH(booking_date) = $month AND financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
            $current_package_sale_m = $sq_package_month['net_total'];
            $previous_package_sale_m = $sq_package_month_pre['net_total'];
            $is_exist =  in_array($ledger_name['ledger_name'],$pckg_ledger_arr);
            array_push($pckg_ledger_arr,$ledger_name['ledger_name']);
            if($is_exist!=1){
                ?>
                <tr> 
                    <td><?= $ledger_name['ledger_name'] ?></td>
            ...
            ?>
            <tr> 
                <td><b>Hotel Sale</b></td>
                <td></td><td></td><td></td><td></td>
            </tr>
            <?php
            $hotel_ledger_arr = array();
            $sql_hotel = mysql_query("select * from hotel_booking_master");
            while($row=mysql_fetch_assoc($sql_hotel)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                $sq_hotel = mysql_fetch_assoc(mysql_query("select sum(total_fee) as hotel_total from hotel_booking_master where financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
                $sq_hotel_pre = mysql_fetch_assoc(mysql_query("select sum(total_fee) as hotel_total from hotel_booking_master where financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
                ...
                FROM hotel_booking_master WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
                $sq_hotel_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(total_fee) as hotel_total
                FROM hotel_booking_master WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
                $pre_month_hotel = $sq_hotel_month_pre['hotel_total'];
                $current_month_hotel = $sq_hotel_month['hotel_total'];
                $is_exist =  in_array($ledger_name['ledger_name'],$hotel_ledger_arr);
                array_push($hotel_ledger_arr,$ledger_name['ledger_name']);
                   if($is_exist!=1){
                ?>
                <tr> 
                    <td><?= $ledger_name['ledger_name'] ?></td>
            ...
            $sql_bus = mysql_query("select * from bus_booking_master");
            while($row=mysql_fetch_assoc($sql_bus)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                    ...
                    FROM bus_booking_master WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id'"));
        
                    $sq_bus_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(net_total) as bus_total
                    FROM bus_booking_master WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id'"));
                    $pre_month_bus = $sq_bus_month_pre['bus_total'];
                    $current_month_bus = $sq_bus_month['bus_total'];
        
                    $is_exist =  in_array($ledger_name['ledger_name'],$bus_ledger_arr);
                    array_push($bus_ledger_arr,$ledger_name['ledger_name']);
                    if($is_exist!=1){
                    ?>
                            <tr>
                                <td><?= $ledger_name['ledger_name'] ?></td>
            ...
            if($sq_flight_count!="0" || $sq_flight_pre_count!='0'){
                ?>
                <tr> 
                    <td><b>Flight Sale</b></td>
                    <td></td><td></td><td></td><td></td>
                </tr>
                <?php
            $flight_ledger_arr = array();
            $sql_flight = mysql_query("select * from ticket_master");
            while($row=mysql_fetch_assoc($sql_flight)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                ...
                FROM ticket_master WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id'"));
        
                $sq_flight_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(ticket_total_cost) as flight_total
                FROM ticket_master WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id'"));
        
                $pre_month_flight = $sq_flight_month_pre['flight_total'];
                $current_month_flight = $sq_flight_month['flight_total'];
                $is_exist =  in_array($ledger_name['ledger_name'],$flight_ledger_arr);
                array_push($flight_ledger_arr,$ledger_name['ledger_name']);
                if($is_exist!=1){
                    ?>
                            <tr> 
                                <td><?= $ledger_name['ledger_name'] ?></td>
            ...
            if($sq_train_count!="0" || $sq_train_pre_count!='0'){
                ?>
                <tr> 
                    <td><b>Train Sale</b></td>
                    <td></td><td></td><td></td><td></td>
                </tr>
                <?php
            $train_ledger_arr = array();
            $sql_flight = mysql_query("select * from train_ticket_master");
            while($row=mysql_fetch_assoc($sql_flight)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                ...
                FROM train_ticket_master WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id'"));
        
                $sq_train_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(net_total) as net_total
                FROM train_ticket_master WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id'"));
                $pre_month_train = $sq_train_month_pre['net_total'];
                $current_month_train = $sq_train_month['net_total'];
        
                $is_exist =  in_array($ledger_name['ledger_name'],$train_ledger_arr);
                array_push($train_ledger_arr,$ledger_name['ledger_name']);
                if($is_exist!=1){
                    ?>
                            <tr> 
                                <td><?= $ledger_name['ledger_name'] ?></td>
            ...
            $sql_visa = mysql_query("select * from visa_master");
            while($row=mysql_fetch_assoc($sql_visa)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                ...
                FROM visa_master WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id'"));
        
                $sq_visa_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(visa_total_cost) as net_total
                FROM visa_master WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id'"));
                $pre_month_visa = $sq_visa_month_pre['net_total'];
                $current_month_visa = $sq_visa_month['net_total'];
        
                $is_exist =  in_array($ledger_name['ledger_name'],$visa_ledger_arr);
                array_push($visa_ledger_arr,$ledger_name['ledger_name']);
                if($is_exist!=1){
                    ?>
                            <tr> 
                                <td><?= $ledger_name['ledger_name'] ?></td>
            ...
            if($sq_car_count!="0" || $sq_car_pre_count!='0'){
                ?>
                <tr>
                    <td><b>Car Rental Sale</b></td>
                    <td></td><td></td><td></td><td></td>
                </tr>
                <?php
            $car_ledger_arr = array();
            $sql_car = mysql_query("select * from car_rental_booking");
            while($row=mysql_fetch_assoc($sql_car)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id'"));
                ...
                FROM car_rental_booking WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id'"));
        
                $sq_car_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(total_fees) as net_total
                FROM car_rental_booking WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id'"));
                $pre_month_car = $sq_car_month_pre['net_total'];
                $current_month_car = $sq_car_month['net_total'];
                $is_exist =  in_array($ledger_name['ledger_name'],$car_ledger_arr);
                array_push($car_ledger_arr,$ledger_name['ledger_name']);
                if($is_exist!=1){
            ...
            if($sq_exc_count!="0" || $sq_exc_pre_count!='0'){
                ?>
                <tr> 
                    <td><b>Activity Sale</b></td>
                    <td></td><td></td><td></td><td></td>
                </tr>
                <?php
            $misc_ledger_arr = array();
            $sql_exc = mysql_query("select * from excursion_master");
            while($row=mysql_fetch_assoc($sql_exc)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                ...
                FROM excursion_master WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id'"));
        
                $sq_exc_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(exc_total_cost) as net_total
                FROM excursion_master WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id'"));
                $pre_month_act = $sq_exc_month_pre['net_total'];
                $current_month_act = $sq_exc_month['net_total'];
                $is_exist =  in_array($ledger_name['ledger_name'],$misc_ledger_arr);
                array_push($misc_ledger_arr,$ledger_name['ledger_name']);
                if($is_exist!=1){
            ...
            if($sq_misc_count!="0" || $sq_misc_pre_count!='0'){
                ?>
                <tr> 
                    <td><b>Miscelaneous Sale</b></td>
                    <td></td><td></td><td></td><td></td>
                </tr>
                <?php
            $misc_ledger_arr = array();
            $sql_misc = mysql_query("select * from miscellaneous_master");
            while($row=mysql_fetch_assoc($sql_misc)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
            ...
            FROM miscellaneous_master WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id'"));
            
            $sq_misc_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(misc_total_cost) as net_total
            FROM miscellaneous_master WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id'"));
            ...
            if($sq_forex_count!="0" || $sq_forex_pre_count!='0'){
                ?>
                <tr> 
                    <td><b>Forex Sale</b></td>
                    <td></td><td></td><td></td><td></td>
                </tr>
                <?php
            $forex_ledger_arr = array();
            $sql_forex = mysql_query("select * from forex_booking_master");
            while($row=mysql_fetch_assoc($sql_forex)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                ...
                $is_exist =  in_array($ledger_name['ledger_name'],$forex_ledger_arr);
                array_push($forex_ledger_arr,$ledger_name['ledger_name']);
                if($is_exist!=1){
            ...
            if($sq_passport_count!=0 || $sq_passport_pre_count!=0){
                ?>
                <tr>
                    <td><b>Passport Sale</b></td>
                    <td></td><td></td><td></td><td></td>
                    
                </tr>
                <?php
            $passort_ledger_arr = array();
            $sql_passort = mysql_query("select * from passport_master");
            while($row=mysql_fetch_assoc($sql_passort)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                ...
                FROM passport_master WHERE MONTH(created_at) = $month AND financial_year_id='$financial_year_id'"));
        
                $sq_passport_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(passport_total_cost) as net_total
                FROM passport_master WHERE MONTH(created_at) = $month AND financial_year_id='$pre_financial_year_id'"));
                $pre_month_passport = $sq_passport_month_pre['net_total'];
                $current_month_passport = $sq_passport_month['net_total'];
                $is_exist =  in_array($ledger_name['ledger_name'],$passort_ledger_arr);
                array_push($passort_ledger_arr,$ledger_name['ledger_name']);
                if($is_exist!=1){
        ...
        <tfoot>
            ...
            <tr class="active">
                ...
                <th style="font-weight: bold;"><?= number_format($total_pre_month_sale, 2) ?></th>
                <th style="font-weight: bold;"><?= number_format($total_current_month_sale, 2) ?></th>
                <th style="font-weight: bold;"><?= number_format($total_pre_yr_sale, 2) ?></th>
                <th style="font-weight: bold;"><?= number_format($total_current_yr_sale, 2) ?></th>
            </tr>
        </tfoot>
    </table>
</div> </div> </div>
<script>
$('#tbl_listgs').DataTable({
