...
<div class="app_panel_content Filter-panel">
	<div class="row">
		<div class="col-md-3 mg_bt_10_xs">
			<input type="text" name="from_date_filteru" id="from_date_filteru" placeholder="From Date" title="From Date" value="<?=date('d-m-Y 00:00:00')?>" onchange="get_to_datetime(this.id,'to_date_filteru');">
		</div>
		<div class="col-md-3 mg_bt_10_xs">
			<input type="text" name="to_date_filteru" id="to_date_filteru" placeholder="To Date" title="To Date" value="<?=date('d-m-Y 23:00:00')?>" onchange="validate_validDatetime('from_date_filteru','to_date_filteru');">
		</div>
		<div class="col-md-3">
...
$('#from_date_filteru, #to_date_filteru').datetimepicker({ format:'d-m-Y H:i:s' });
var column = [
{ title : "S_No."},
