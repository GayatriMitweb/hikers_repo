...
<div class="row text-right mg_bt_10">
	<div class="col-md-12">
        ...
        <button type="button" class="btn btn-info btn-sm ico_left" id="btn_save_modal" title="Add New User" onclick="save_modal()"><i class="fa fa-plus"></i>&nbsp;&nbsp;New Salary</button>
	</div>
</div>
	...
	<div class="row">
		<div class="col-md-3 col-sm-6 mg_bt_10_xs">
			<select name="year_filter1" style="width: 100%" id="year_filter1" title="Year" required>
				...
				<?php 
				for($year_count=2019; $year_count<2099; $year_count++){
					?>
