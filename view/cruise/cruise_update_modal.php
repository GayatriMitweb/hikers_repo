        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
            <legend>Cruise Supplier Information</legend>
              ...
              <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <input type="text" class="form-control" value="<?= $mobile_no ?>" id="mobile_no1" name="mobile_no1" placeholder="*Mobile Number" onchange="mobile_validate(this.id);" title="Mobile Number" required>
                  </div>
                  <div class="col-md-3 col-sm-6 mg_bt_10">
