...
$sq_cruise= mysql_fetch_assoc(mysql_query("select * from cruise_master where cruise_id='$cruise_id'"));
...
<div class="modal fade profile_box_modal" id="cruise_view_modal" role="dialog" aria-labelledby="myModalLabel">
						     	...
						     	<div class="row">
									...
									<div class="col-md-12">
							        	...
							        	<?php 
							        		...
							        		$sq_city = mysql_fetch_assoc(mysql_query("select * from city_master where city_id='$sq_cruise[city_id]'")); 
							        		...
							        		<div class="row">
							        			...
							        			<div class="col-md-6">
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Account Name <em>:</em></label> " .$sq_cruise['account_name']; ?> 
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>PAN/TAN No <em>:</em></label> " .$sq_cruise['pan_no']; ?>
