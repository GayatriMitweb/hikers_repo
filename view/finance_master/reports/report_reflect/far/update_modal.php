  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
              <select id="asset_type" name="asset_type" onchange="get_assets(this.id,'2')" style="width: 100%" title="Asset Type" disabled>
                <?php 
            ...
            <div class="col-md-4">
              <select id="asset_name2" name="asset_name2" style="width: 100%" title="Asset Name" disabled>
                  <option value="<?= $sq_query['entry_id'] ?>"><?= $sq_query['asset_name'] ?></option>
              </select>
            </div>
            <div class="col-md-4">
              <input type="text" name="asset_ledger_name1" id="asset_ledger_name1" placeholder="Asset Ledger Name" title="Asset Ledger Name" value="<?= $sq_asset['asset_ledger'] ?>">
            </div>            
          </div>   
          <div class="row mg_tp_20">
            <div class="col-md-4">
              <input type="text" name="purchase_date1" id="purchase_date1" placeholder="Purchase Date" title="Purchase Date" value="<?= get_date_user($sq_asset['purchase_date']) ?>" readonly>
            </div>
            <div class="col-md-4">
              <input type="text" name="purchase_amount1" id="purchase_amount1" placeholder="Purchase Amount" title="Purchase Amount"  value="<?= $sq_asset['purchase_amount'] ?>" onchange="calculate_depreciation_amount('purchase_amount1','depr_type2','rate_of_depr1','depr_interval1','purchase_date1','asset_name2','asset_ledger_name1','1')" readonly>
            </div>
            <div class="col-md-4">
              <select id="depr_type2" name="depr_type2" style="width: 100%" onchange="calculate_depreciation_amount('purchase_amount1','depr_type2','rate_of_depr1','depr_interval1','purchase_date1','asset_name2','asset_ledger_name1','1')" title="Depreciation Type">
          ...
          <div class="row mg_tp_20">       
            <div class="col-md-4">
              <input type="text" name="rate_of_depr1" id="rate_of_depr1" placeholder="Rate of Depreciation" title="Rate of Depreciation"onchange="calculate_depreciation_amount('purchase_amount1','depr_type2','rate_of_depr1','depr_interval1','purchase_date1','asset_name2','asset_ledger_name1','1')" value="<?= $sq_asset['rate_of_depr'] ?>">
            </div>
            <div class="col-md-4">
          ...
          <div class="row mg_tp_20">
            <div class="col-md-12">
              <TEXTAREA name="remark" id="remark" placeholder="Remark" title="Remark"><?= $sq_asset['remark'] ?></TEXTAREA> 
            </div>
          </div>
          <div class="row mg_tp_20">
            <div class="col-md-12">
