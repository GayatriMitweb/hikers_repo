  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
              <select id="asset_type" name="asset_type" onchange="get_assets(this.id)" style="width: 100%" title="Type of Asset">
            ...
            <div class="col-md-4">
              <select id="asset_name" name="asset_name" style="width: 100%" title="Select Asset">
                  <option value="">*Select Asset</option>
              </select>
            </div>
            <div class="col-md-4">
              <input type="text" name="asset_ledger_name" id="asset_ledger_name" placeholder="*Asset Ledger Name" title="Asset Ledger Name">
            </div>            
          </div>   
          <div class="row mg_tp_20">
            <div class="col-md-4">
              <input type="text" name="purchase_date" id="purchase_date" placeholder="*Purchase Date" title="Purchase Date">
            </div>
            <div class="col-md-4">
              <input type="text" name="purchase_amount" id="purchase_amount" placeholder="*Purchase Amount" title="Purchase Amount" onchange="calculate_depreciation_amount('purchase_amount','depr_type','rate_of_depr','depr_interval','purchase_date','asset_name','asset_ledger_name')">
            </div>
            <div class="col-md-4">
              <select id="depr_type" name="depr_type" style="width: 100%" onchange="calculate_depreciation_amount('purchase_amount','depr_type','rate_of_depr','depr_interval','purchase_date','asset_name','asset_ledger_name')" title="Depreciation Type">
          ...
          <div class="row mg_tp_20">       
            <div class="col-md-4">
              <input type="text" name="rate_of_depr" id="rate_of_depr" placeholder="*Rate of Depreciation" title="Rate of Depreciation" onchange="calculate_depreciation_amount('purchase_amount','depr_type','rate_of_depr','depr_interval','purchase_date','asset_name','asset_ledger_name')">
            </div>
            <div class="col-md-4">
          ...
          <div class="row mg_tp_20">
            <div class="col-md-12">
              <TEXTAREA name="remark" id="remark" placeholder="Remark" title="Remark"></TEXTAREA> 
            </div>
          </div>
          <div class="row mg_tp_20">
            <div class="col-md-12">
