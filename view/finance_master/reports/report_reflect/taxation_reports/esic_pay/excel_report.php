...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('F'.$row_count, "ESIC_Deducted");
...
while($row_query = mysql_fetch_assoc($sq_query))
{
  ...
  $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('E'.$row_count, number_format($row_query['gross_salary'],2))

        ->setCellValue('F'.$row_count, number_format($row_query['esic'],2));
...
header('Content-Disposition: attachment;filename="ESIC Payable('.date('d-m-Y H:i:s').').xls"');
