...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('E'.$row_count, "Employer Contribution")

        ->setCellValue('F'.$row_count, "User Contribution")
...
while($row_query = mysql_fetch_assoc($sq_query))
{
  ...
  $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('E'.$row_count, $row_query['employer_pf'])

        ->setCellValue('F'.$row_count, $row_query['employee_pf'])

        ->setCellValue('G'.$row_count, number_format($row_query['employee_pf'] + $row_query['employer_pf'],2));
