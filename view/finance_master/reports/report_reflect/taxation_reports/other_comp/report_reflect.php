...
$sq_query = mysql_query($query);
	...
	$temp_arr = array( "data" => array(
		...
		($row_query['comp_date'] == '0000-00-00')?'<button class="btn btn-info btn-sm" onclick="update_modal('. $row_query['id'] .')" title="Complied Date"><i class="fa fa-edit" title="Edit complied date"></i></button>' : get_date_user($row_query['comp_date'])
		), "bg" =>$bg);
