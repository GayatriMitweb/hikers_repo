...
<div class="container">
	...
	<div class="app_panel_content Filter-panel" style="margin: 0 !important;  width: 100% !important;">
	  <div class="row">
			...
			<div class="col-md-2">
				<input type="checkbox" id="chk_opnbalance" name="chk_opnbalance" checked><label for="chk_opnbalance">&nbsp;&nbsp;Opening Balance</label>
			</div>
			<div class="col-md-2">
				<input type="checkbox" id="chk_trans" name="chk_trans" ><label for="chk_trans">&nbsp;&nbsp;Fortnightly Clubing</label>
			</div>
