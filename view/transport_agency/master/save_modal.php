      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel">
        <legend>Transporter Information</legend>
			  <div class="row">
			    ...
			    <div class="col-md-3 col-sm-6 mg_bt_10">
			      <input type="text" class="form-control" onchange="mobile_validate(this.id);"  id="txt_mobile_no" name="txt_mobile_no" title="Mobile Number" placeholder="*Mobile Number" required>
			    </div>
          <div class="col-md-3 col-sm-6 mg_bt_10">
