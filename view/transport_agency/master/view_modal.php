...
<div class="modal fade profile_box_modal" id="transport_view_modal" role="dialog" aria-labelledby="myModalLabel">
							        	...
							        	<?php $sq_city = mysql_fetch_assoc(mysql_query("select city_name from city_master where city_id='$sq_transport_agency[city_id]'")); ?>
							        		...
							        		<div class="row">
           										...
           										<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd">
							        				...
							        				<?php $sq_state = mysql_fetch_assoc(mysql_query("select * from state_master where id='$sq_transport_agency[state_id]'"));
                   									 ?> 
							        				 <span class="main_block">
							        			...
							        			<div class="col-md-6">
							        				...
							        				<span class="main_block"> 
							        				    ...
							        				    <?php echo "<label>Account Name <em>:</em></label> " .$sq_transport_agency['account_name']; ?>
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>IFSC/SWIFT CODE <em>:</em></label> " .$sq_transport_agency['ifsc_code']; ?>
