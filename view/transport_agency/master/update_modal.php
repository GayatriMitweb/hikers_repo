  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <input type="hidden" id="vendor_login_id" name="vendor_login_id" value="<?= $sq_vendor_login['login_id'] ?>">
		  <div class="row">
		    ...
		    <div class="col-md-3 col-sm-6 mg_bt_10">
		      <input type="text" class="form-control"  onchange="mobile_validate(this.id);" id="txt_mobile_no" name="txt_mobile_no" placeholder="*Mobile Number" title="Mobile Number" value="<?php echo $mobile_no ?>" required>
		    </div>	
        <div class="col-md-3 col-sm-6 mg_bt_10">
