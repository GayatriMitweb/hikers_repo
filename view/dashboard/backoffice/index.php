                      ...
                      <div class="dashboard_table_body main_block">
                        ...
                        ?>
                            ...
                            $sql_hotel = mysql_query($query1);
                              ...
                              $branch_status = $sq['branch_status'];
                              $query_train = "select *	from  ticket_trip_entries where departure_datetime<= '$today1' and arrival_datetime>= '$today1' and status!='Cancel'
                              group by ticket_id";
                              ...
                              $branch_status = $sq['branch_status'];
                              $query_train = "select *	from  train_ticket_master_trip_entries where DATE(travel_datetime)<= '$today' and DATE(arriving_datetime) >= '$today' and status!='Cancel'
                             ...
                             <!-- Car Rental Booking -->
                                  ...
                                  $branch_status = $sq['branch_status'];
                                  $query_car = "select * from car_rental_booking  where traveling_date='$today' and travel_type ='Local' and status!='Cancel'";
                                ...
                                while($row_query1=mysql_fetch_assoc($sq_query_car)){
                                  ...
                                  <!-- Car Rental Booking -->
                                  <?php
                                  $query_car = "select * from car_rental_booking  where traveling_date='$today' and travel_type ='Outstation' and status!='Cancel'";
                              ...
                              <!-- Group Booking -->
                                  ...
                                  $query_grp = "select * from tour_groups where from_date<='$today' and to_date>='$today'";
                                    ...
                                    $query1 = "select * from tourwise_traveler_details where tour_id='$row_query1[tour_id]' and tour_group_status!='Cancel'";
                              ...
                              $query_visa = "select *	from  visa_master_entries where appointment_date='$today' and status!='Cancel'	group by visa_id";
                              ...
                              while($sq_visa = mysql_fetch_assoc($sql_pass)){
                                ...
                                <?php
                                $query_pass = "select * from  miscellaneous_master where created_at >= '$today' and emp_id='$emp_id' and misc_id in(SELECT `misc_id` FROM `miscellaneous_master_entries` WHERE `status`!='Cancel' group by `misc_id`) order by misc_id desc";
                                      $sq_query_pass = mysql_query($query_pass);
                                      while($row_query_visa=mysql_fetch_assoc($sq_query_pass)){
                                  ...
                                  <!-- Forex Booking -->
                                <?php
                                $query_pass = "select * from forex_booking_master where DATE(created_at) >= '$today' and emp_id='$emp_id' order by booking_id desc";
                                      $sq_query_pass = mysql_query($query_pass);
                                      while($row_query_visa=mysql_fetch_assoc($sq_query_pass)){
                                  $sq_cust = mysql_fetch_assoc(mysql_query("select * from customer_master where customer_id = '$row_query_visa[customer_id]'"));
                                  $contact_no = $encrypt_decrypt->fnDecrypt($sq_cust['contact_no'], $secret_key);
                        ...
                        <div class="col-md-12 no-pad table_verflow"> 
                          <div class="table-responsive">
                            ...
                            while($row_query=mysql_fetch_assoc($sq_query)){
                              ...
                              $query1 = "select * from  hotel_booking_entries where status!='Cancel' and check_in >= '$today' and booking_id in(select booking_id from hotel_booking_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel'";                              
                              $sq_query = mysql_query($query1);
                              while($row_query=mysql_fetch_assoc($sq_query)){
                              ...
                              $branch_status = $sq['branch_status'];
                              $query_flight = "select *
                              from  ticket_trip_entries where departure_datetime >= '$today' and ticket_id in(select ticket_id from ticket_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel'
                              group by ticket_id";
                            ...
                            while($row_query1=mysql_fetch_assoc($sq_query1)){
                              ...
                              $branch_status = $sq['branch_status'];
                              $query_train = "select *
                              from  train_ticket_master_trip_entries where DATE(travel_datetime) >= '$today' and train_ticket_id in(select train_ticket_id from train_ticket_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by train_ticket_id";
                              $sq_query_train = mysql_query($query_train);
                              while($row_query1=mysql_fetch_assoc($sq_query_train)){
                              ...
                              $sq = mysql_fetch_assoc(mysql_query("select * from branch_assign where link='bus_booking/booking/index.php'"));
                              $branch_status = $sq['branch_status'];
                              $query_bus = "select * from bus_booking_entries where DATE(date_of_journey) >= '$today' and and booking_id in(select booking_id from bus_booking_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by booking_id";
                                    $sq_query_bus = mysql_query($query_bus);
                                    while($row_query1=mysql_fetch_assoc($sq_query_bus)){
                              ...
                              $sq = mysql_fetch_assoc(mysql_query("select * from branch_assign where link='excursion/index.php'"));
                              $branch_status = $sq['branch_status'];
                              $query_exc = "select * from  excursion_master_entries where DATE(exc_date) >= '$today1' and exc_id in(select exc_id from excursion_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by exc_id";
                              $sq_query_exc = mysql_query($query_exc);
                              while($row_query1=mysql_fetch_assoc($sq_query_exc)){
                              ...
                              <?php } ?>
                              <?php
                              $query_car = "select * from car_rental_booking where traveling_date  >= '$today1'  and travel_type ='Outstation' and status!='Cancel' and financial_year_id='$financial_year_id'";
                              if($branch_status=='yes'){
                                if($role=='Branch Admin' || $role=='Accountant' || $role_id>'7'){
                                  $query_car .= " and branch_admin_id = '$branch_admin_id'";
                                }
                              ...
                              <!-- Group Booking -->
                              <?php
                              $sq = mysql_query("select * from tourwise_traveler_details where 1 and and emp_id='$emp_id' and financial_year_id='$financial_year_id' and tour_group_status!='Cancel'");
                              while($row_query = mysql_fetch_assoc($sq)){
                            ...
                            ?>
                              ...
                              $sq = mysql_fetch_assoc(mysql_query("select * from branch_assign where link='visa_passport_ticket/visa/index.php'"));
                              $branch_status = $sq['branch_status'];
                              $query_visa = "select * from  visa_master_entries where appointment_date >= '$today1' and visa_id in(select visa_id from visa_master where emp_id='$emp_id' and financial_year_id='$financial_year_id')  and status!='Cancel' group by visa_id";
                                    $sq_query_visa = mysql_query($query_visa);
                              while($row_query_visa=mysql_fetch_assoc($sq_query_visa)){
                              ...
                              $sq = mysql_fetch_assoc(mysql_query("select * from branch_assign where link='visa_passport_ticket/passport/index.php'"));
                              $branch_status = $sq['branch_status'];
                              $query_pass = "select * from  passport_master_entries where DATE(appointment_date) >= '$today' and passport_id in(select passport_id from passport_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by passport_id";
