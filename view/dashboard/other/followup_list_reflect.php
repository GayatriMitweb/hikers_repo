    ...
    <div class="table-responsive">
        ...
        <?php
            ...
            <tr class=<?= $bg ?>>
                ...
                <td><?php echo($sq_c['tour_name']=='')?'NA':$sq_c['tour_name'] ?></td>
                ...
                <td><button class="btn btn-info btn-sm" onclick="Followup_update('<?php echo $row['enquiry_id']; ?>');" title="Update Checklist" target="_blank"><i class="fa fa-reply-all"></i></button></td>
            </tr>
            <?php
                }
            } ?>
