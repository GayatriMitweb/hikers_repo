                                  ...
                                  <?php
                                    $query1 = "select * from package_tour_booking_master where tour_status!='Disabled' and financial_year_id='$financial_year_id' and emp_id = '$emp_id' and tour_from_date <= '$today' and tour_to_date >= '$today'";
                                          ...
                                          ?>
                                            ...
                                            <td><button class="btn btn-info btn-sm" onclick="send_sms(<?= $row_query['booking_id'] ?>,'Package Booking',<?= $row_query['emp_id']?>,<?= $contact_no?>)" title="Send SMS"><i class="fa fa-paper-plane-o"></i></button></td>
                                          </tr>
                                    <?php } } ?>
                                    <?php
                                      // hotel Booking
                                        $query1 = "select *	from  hotel_booking_entries where status!='Cancel' and check_in<= '$today1' and check_out >= '$today1' and booking_id in(select booking_id from hotel_booking_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by booking_id";
                                        $sq_query = mysql_query($query1);
                                        while($row_query=mysql_fetch_assoc($sq_query)){
                                        ...
                                        $sql_hotel = mysql_query("select * from hotel_booking_master where booking_id = '$row_query[booking_id]' and emp_id = '$emp_id'");
                                          ...
                                          <!-- flight Booking -->
                                          <?php
                                          $query_train = "select *	from  ticket_trip_entries where departure_datetime<= '$today1' and arrival_datetime>= '$today1' and ticket_id in(select ticket_id from ticket_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by ticket_id";
                                          ...
                                          <!-- Train Booking -->
                                          <?php
                                          $query_train = "select *	from  train_ticket_master_trip_entries where DATE(travel_datetime) <= '$today' and DATE(arriving_datetime)>= '$today' and train_ticket_id in(select train_ticket_id from train_ticket_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by train_ticket_id";
                                          ...
                                          <!-- Bus Booking -->
                                          <?php
                                          $query_bus = "select *	from  bus_booking_entries where DATE(date_of_journey)	= '$today' and booking_id in(select booking_id from bus_booking_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by booking_id";
                                          ...
                                          $query_exc = "select *	from  excursion_master_entries where DATE(exc_date) ='$today' and exc_id in(select exc_id from excursion_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status!='Cancel' group by exc_id";
                                          ...
                                          while( $sq_hotel = mysql_fetch_assoc($sql_exc)){
                                            ...
                                            <?php } }?>
                                            <?php
                                          $query_car = "select * from car_rental_booking  where traveling_date='$today' and travel_type ='Local' and emp_id='$emp_id' and status!='Cancel' and financial_year_id='$financial_year_id'";
                                          ...
                                          <!-- Car Rental Booking -->
                                          <?php
                                          $query_car = "select * from car_rental_booking  where traveling_date='$today' and travel_type ='Outstation' and emp_id='$emp_id' and status!='Cancel' and financial_year_id='$financial_year_id'";
                                          ...
                                          <!-- Group Booking -->
                                          <?php
                                            $sq = mysql_query("select * from tourwise_traveler_details where 1 and emp_id='$emp_id' and financial_year_id='$financial_year_id'");
                                            ...
                                            ?>
                                              ...
                                              <td><?php echo $contact_no; ?></td>
                                              <td><?= ($row_query['emp_id']=='0') ? "Admin" : $sq_emp['first_name'].' '.$sq_emp['last_name'] ?></td>
                                              <td><button class="btn btn-info btn-sm" onclick="send_sms(<?= $row_query['id'] ?>,'Group Booking',<?= $row_query['emp_id']?>,'<?= $contact_no?>')" title="Send SMS"><i class="fa fa-paper-plane-o"></i></button></td>
                                              </tr>
                                          <?php } }?>
                                          <!-- Visa Booking -->
                                          <?php
                                            $query_visa = "select *	from  visa_master_entries where appointment_date='$today' and visa_id in(select visa_id from visa_master where emp_id='$emp_id' and financial_year_id='$financial_year_id')  and status!='Cancel' group by visa_id";

                                          $sq_query_visa = mysql_query($query_visa);
                                          while($row_query_visa=mysql_fetch_assoc($sq_query_visa)){
                                            $sq_visac = mysql_num_rows(mysql_query("select * from visa_master where visa_id = '$row_query_visa[visa_id]'"));
                                            if($sq_visac!=0){
                                            ...
                                            <!-- Passport Booking -->
                                          <?php
                                          $query_pass = "select *	from  passport_master_entries where appointment_date='$today' and passport_id in(select passport_id from passport_master where emp_id='$emp_id' and financial_year_id='$financial_year_id')  and status!='Cancel' group by passport_id";
                              ...
                              <div class="col-md-12 no-pad table_verflow"> 
                                <div class="table-responsive">
                                  <table class="table table-hover" style="margin: 0 !important;border: 0;">
                                    ...
                                    <!-- Hotel Booking -->
                                    <?php
                                    $query1 = "select * from  hotel_booking_entries where status!='Cancel' and check_in > '$today' and booking_id in(select booking_id from hotel_booking_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') group by booking_id";
                                    $sq_query = mysql_query($query1);
                                    while($row_query=mysql_fetch_assoc($sq_query)){
                                      
                                      $sq = mysql_query("select * from hotel_booking_master where booking_id = '$row_query[booking_id]' and emp_id='$emp_id'");
                                    ...
                                    <!-- Flight Booking -->
                                    <?php
                                    $query_flight = "select * from  ticket_trip_entries where departure_datetime > '$today' and ticket_id in(select ticket_id from ticket_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status != 'Cancel' group by ticket_id";
                                    ...
                                    $query_train = "select * from  train_ticket_master_trip_entries where DATE(travel_datetime) > '$today' and train_ticket_id in(select train_ticket_id from train_ticket_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') and status != 'Cancel' group by train_ticket_id";
                                          $sq_query_train = mysql_query($query_train);
                                          while($row_query1=mysql_fetch_assoc($sq_query_train)){
                                    ...
                                    <!-- Bus Booking -->
                                    <?php                                    
                                    $query_bus = "select * from bus_booking_entries where DATE(date_of_journey) > '$today' and status!='Cancel' and booking_id in(select booking_id from bus_booking_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') group by booking_id";
                                          $sq_query_bus = mysql_query($query_bus);
                                          while($row_query1=mysql_fetch_assoc($sq_query_bus)){
                                            $sq_hotelc = mysql_num_rows(mysql_query("select * from bus_booking_master where booking_id = '$row_query1[booking_id]' and emp_id='$emp_id'"));
                                            if($sq_hotelc!=0){
                                    ...
                                    $query_exc = "select *
                                    from  excursion_master_entries where DATE(exc_date) > '$today1' and status!='Cancel' and exc_id in(select exc_id from excursion_master where emp_id='$emp_id' and financial_year_id='$financial_year_id') group by exc_id";
                                          $sq_query_exc = mysql_query($query_exc);
                                          while($row_query1=mysql_fetch_assoc($sq_query_exc)){
                                  ...
                                  ?>
                                    <!-- Visa Booking -->
                                    <?php                                    
                                    $query_visa = "select * from  visa_master_entries where appointment_date > '$today1' and status!='Cancel' and visa_id in(select visa_id from visa_master where emp_id='$emp_id' and financial_year_id='$financial_year_id')	group by visa_id";
                                          $sq_query_visa = mysql_query($query_visa);
                                          while($row_query_visa=mysql_fetch_assoc($sq_query_visa)){
                                    ...
                                    $query_pass = "select * from  passport_master_entries where appointment_date > '$today1' and passport_id in(select passport_id from passport_master where emp_id='$emp_id' and financial_year_id='$financial_year_id')  and status != 'Cancel' group by passport_id";
                                          $sq_query_pass = mysql_query($query_pass);
                                          while($row_query_visa=mysql_fetch_assoc($sq_query_pass)){
                                            $sq_visac = mysql_num_rows(mysql_query("select * from passport_master where passport_id = '$row_query_visa[passport_id]'"));
                                      if($sq_visac!=0){
                                    ...
                                    $query_pass = "select * from  miscellaneous_master where created_at > '$today1' and emp_id='$emp_id' and financial_year_id='$financial_year_id' order by misc_id desc";
                                      ...
                                      $sq_mcount = mysql_fetch_assoc(mysql_query("select * from  miscellaneous_master_entries where misc_id = '$row_query_visa[misc_id]' and status!='Cancel'"));
                                      if($sq_mcount != 0) {
                                      ...
                                      <!-- Forex Booking -->
                                    <?php
                                    $query_pass = "select * from forex_booking_master where DATE(created_at) > '$today1' and emp_id='$emp_id' and financial_year_id='$financial_year_id' order by booking_id desc";
                                          $sq_query_pass = mysql_query($query_pass);
                                          while($row_query_visa=mysql_fetch_assoc($sq_query_pass)){
                                      $sq_cust = mysql_fetch_assoc(mysql_query("select * from customer_master where customer_id = '$row_query_visa[customer_id]'"));
                                      $contact_no = $encrypt_decrypt->fnDecrypt($sq_cust['contact_no'], $secret_key);
