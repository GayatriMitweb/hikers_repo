...
$query = mysql_fetch_assoc(mysql_query("select max(booking_id) as booking_id,net_total as net_total from package_tour_booking_master where financial_year_id='$financial_year_id'"));
