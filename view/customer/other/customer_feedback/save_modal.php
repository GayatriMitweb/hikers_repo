          ...
          <div class="row ">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="panel panel-default panel-body app_panel_style">
                  <input type="radio" id="professional" name="sales_team" value="Professional" onchange="sales_team_comment_reflect()"><label class="feedback_option_lable" for="professional">Professional</label>
                  <input type="radio" id="friendly" name="sales_team" value="Friendly" onchange="sales_team_comment_reflect()"><label class="feedback_option_lable" for="friendly">Friendly</label>
                  <input type="radio" id="catered_instinctively" name="sales_team" value="Catered Instinctively" onchange="sales_team_comment_reflect()"><label class="feedback_option_lable" for="catered_instinctively">Catered Instinctively</label>
                  <input type="radio" id="informative" name="sales_team" value="Informative" onchange="sales_team_comment_reflect()"><label class="feedback_option_lable" for="informative">Informative</label>
...
function sales_team_comment_reflect(){
    var sales_team = $('input[name="sales_team"]:checked').attr('id')
        if(sales_team=='none_of_these')
        {
          ...
          $('#sales_team_comment').addClass('hidden');
        }
}
$('#frm_save').validate({
  rules:{
