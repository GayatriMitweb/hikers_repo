          ...
          <form id="frm_dmc_update">
            <div class="panel panel-default panel-body app_panel_style feildset-panel">
              ...
              <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <input type="text" class="form-control" value="<?= $mobile_no ?>"  onchange="mobile_validate(this.id);" id="mobile_no1" name="mobile_no1" placeholder="*Mobile Number" title="Mobile Number" required>
                  </div>
                  <div class="col-md-3 col-sm-6 mg_bt_10">
