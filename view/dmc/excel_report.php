...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('D'.$row_count, "DMC Name")
...
->setCellValue('B'.$row_count, $query);
...
while($row_hotel = mysql_fetch_assoc($sq_hotel)){
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('D'.$row_count, $row_hotel['company_name'])
...
header('Content-Disposition: attachment;filename="DMC_Supplier('.date('d-m-Y H:i:s').').xls"');
