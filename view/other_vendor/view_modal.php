...
<div class="modal fade profile_box_modal" id="other_vendor_view_modal" role="dialog" aria-labelledby="myModalLabel">
      		...
      		<div class="modal-body profile_box_padding">
				  ...
				  <!-- Nav tabs -->
				  	...
				  	<ul class="nav nav-tabs" role="tablist">
				    	...
				    	<li role="presentation" class="active"><a href="#basic_information" aria-controls="home" role="tab" data-toggle="tab" class="tab_name">Other Supplier Information</a></li>
							        		...
							        		<div class="row">
           										...
           										<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd">
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Occupation <em>:</em></label> " .$sq_vendor['profession']; ?>
...
$('#other_vendor_view_modal').modal('show');
