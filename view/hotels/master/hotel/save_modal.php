      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
         ...
         <div class="row mg_bt_10"> 
            ...
            <div class="col-md-2 col-sm-6 ">
                <input type="text" class="form-control" id="txt_mobile_no" onchange="mobile_validate(this.id);" name="txt_mobile_no" placeholder="*Mobile Number" title="Mobile Number" required>
            </div>	
            <div class="col-md-2 col-sm-6 ">
