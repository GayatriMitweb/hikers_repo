    ...
    <div class="panel panel-default panel-body app_panel_style feildset-panel">
        <legend>Basic Information</legend>
		    ...
		    <div class="row">
		        ...
		        <div class="col-md-2 col-sm-6 mg_bt_10">
		            <input type="text" value="<?= $mobile_no ?>" onchange="mobile_validate(this.id);" class="form-control" id="txt_mobile_no" name="txt_mobile_no" placeholder="*Mobile Number" title="Mobile Number" required>
		        </div>  
            <div class="col-md-2 col-sm-6 mg_bt_10">
