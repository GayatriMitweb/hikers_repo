        ...
        <form id="frm_hotel_booking_save">
         ...
         <legend>Quotation Details</legend>
          <div class="row">
            ...
            <select name="quotation_id" id="quotation_id" style="width:100%" onchange="get_quotation_details(this)" class="form-control text-center">
